...
public partial class CategoryEditWindow:Window
{
    ...
    private void Save_Click(object sender,RoutedEventArgs e){var n=NameBox.Text.Trim();if(n.Length==0){MessageBox.Show("نام دسته را وارد کنید.","حسابداری آسان");return;}CategoryName=n;DialogResult=true;}
