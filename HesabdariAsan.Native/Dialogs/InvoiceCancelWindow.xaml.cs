...
public partial class InvoiceCancelWindow : Window
{
    ...
    private void Confirm_Click(object sender, RoutedEventArgs e) { if (Reason.Length < 2) { AppDialog.Show("دلیل ابطال را بنویسید.", "ابطال فاکتور"); return; } DialogResult = true; }
