...
public partial class DebtPaymentWindow:Window
{
 ...
 private void Save_Click(object sender,RoutedEventArgs e){if(!long.TryParse(AmountBox.Text,out var a)||a<=0){AppDialog.Show("مبلغ درست وارد نشده است.");return;}Amount=a;DialogResult=true;}
