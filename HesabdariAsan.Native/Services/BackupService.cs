...
public sealed class BackupService
{
    ...
    public string ResetToFreshDatabase()
    {
        var safety = CreateBackup("before-reset");
...
DELETE FROM sqlite_sequence;";
        ...
        if (!string.Equals(check, "ok", StringComparison.OrdinalIgnoreCase))
            throw new InvalidDataException("بازنشانی انجام شد اما بررسی سلامت دیتابیس موفق نبود. Backup ایمنی حفظ شده است.");
        return safety;
    }
